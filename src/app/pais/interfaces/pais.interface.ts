...
//
//   const respCountriesResponse = Convert.toRespCountriesResponse(json);
//
...
export class Convert {
    public static toRespCountriesResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RespCountriesResponse")));
    }

    public static respCountriesResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RespCountriesResponse"))), null, 2);
    }
}
